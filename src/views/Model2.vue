<template>
  ...
  <div class="model2-div-cont-part1">
    ...
    <div class="model2-div-cont-modelo1 ">
      ...
      <div
        :class="'model2-boton-practica-auto opt ' + this.emptyA"
    ...
    <div class="model2-div-cont-separator"><hr class="model2-separator" /></div>

    <div class="model2-div-cont-practice">
        <div class="model2-div-cont-canvas">
            <canvas id="model2-mycanvas" :width="canvas_with" :height="canvas_height" style="min-width: 120px; min-height: 120px;"/>
      ...
      <div class="model2-div-cont-practica-conromaji">
        <div
          :class="'model2-boton-practica-conromaji ' + this.emptyR"
          v-on:click="pRomaji"
        >
...
export default {
  ...
  methods: {
    ...
    listenerGeneral() {
      ...
      c.addEventListener("pointerdown", beginDrawing, { capture: true });
